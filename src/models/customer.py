...
class Customer(UserMixin, Base):
    ...
    Membership_Level = Column(String(50), ForeignKey('Member.Membership_Level'), nullable=False)
    ...
    orders = relationship("Order", back_populates="customer", overlaps="customer_id")
    shopping_carts = relationship("ShoppingCart", back_populates="customer")
    customer_id = relationship("Order", back_populates="customer", overlaps="orders")
